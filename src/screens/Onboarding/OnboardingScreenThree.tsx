...
const OnboardingScreenThree = ({ onNext, onPrev, onDotPress, onSkip }: OnboardingScreenThreeProps) => {
  const item = onboardingData[2];
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.container} {...panResponder.panHandlers}>
        ...
        <OnboardingPagination total={3} activeIndex={2} onDotPress={onDotPress} />
