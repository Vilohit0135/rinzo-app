...
import CurrentLocationCard from '../location/CurrentLocationCard';
import SavedAddressList from '../location/SavedAddressList';
import RecentLocationItem from '../location/RecentLocationItem';
...
const LocationBottomSheet = ({ visible, onClose }: LocationBottomSheetProps) => {
            ...
            {showSearchResults ? (
              ...
              <>
                <View style={styles.sectionGap}>
                  <CurrentLocationCard loading={loading} error={error} onPress={handleCurrentLocation} />
                </View>
